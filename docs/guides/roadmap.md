...
### Parcours Build to Earn
- **Produits digitaux : creer et vendre** (8 modules, 24 lecons) — ideation, creation IA, boutique, copywriting, pub, scaling
- **Media Buyer** (4 modules, 15 lecons) — Facebook Ads, Google Ads & Shopping, Meta Andromeda, blocages comptes
- **Creation de contenu avec l'IA** (4 modules, 10 lecons) — YouTube faceless, voix IA, monetisation
- **Vibe Coding** — creer des apps avec l'IA (Lovable, Bolt, v0, Claude Code)
  - *Ressource externe ajoutée :* "Claude AI FULL COURSE — Build & Automate Anything" (EN, 5h)

### Projets
- 8 Starter kits prets a deployer (GitHub → Vercel/Netlify)
...
- Sessions live, notifications

## A venir

| Priorite | Fonctionnalite |
|----------|---------------|
| Haute | Stripe (abonnements Premium/Launch) |
| Haute | Parcours SEO, Reseaux sociaux |
| Haute | Mode sombre, recherche plein texte |
| Haute | PWA offline |
| Haute | Email automatique |
| Haute | Upload fichiers projets |
| Haute | Etoile du nord admin (% projets en ligne, % premier euro) |
...
- `/dashboard/nouveautes` — changements visibles par l'utilisateur
- `ROADMAP_EVOLUTION.md` — feuille de route produit versionnee
- `ANALYSIS_GUIDE.md` — architecture et etat technique
