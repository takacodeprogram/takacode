...
export async function generateMetadata({ params }: { params: Promise<Record<string, string>> }) {
  ...
  if (!project) {
    return buildPageMetadata({ title: "Projet introuvable", path: "/projets" });
  }
      ...
      <main className="pt-[64px]">
        <section className="py-24 md:py-28 px-8">
          <div className="max-w-[930px] mx-auto">
            <Link href="/projets" className="inline-flex items-center gap-1.5 text-[12px] text-[#666] hover:text-white transition-colors mb-6">
