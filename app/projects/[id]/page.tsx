        ...
        <main className="pt-[64px]">
          <section className="py-24 md:py-28 px-8">
            <div className="max-w-[930px] mx-auto text-center">
              ...
              <p className="font-body-readable text-[14px] text-[var(--muted-3)] mb-8">Ce projet n&apos;existe pas ou n&apos;a pas été publie.</p>
      ...
      <main className="pt-[64px]">
        <section className="py-24 md:py-28 px-8">
          <div className="max-w-[930px] mx-auto">
            <Link href={localePath("/projects", locale)} className="inline-flex items-center gap-1.5 text-[12px] text-[var(--muted-4)] hover:text-[var(--text-primary)] transition-colors mb-6">
            ...
            <div className="rounded-2xl border border-[var(--border-3)] bg-[var(--surface-1)] p-6 md:p-8 mb-6">
              <div className="flex items-start justify-between gap-4 mb-6">
                <div className="min-w-0">
                  <div className="text-[10px] text-[var(--muted-4)] uppercase tracking-widest font-semibold mb-1">Projet</div>
              ...
              {project.objective ? (
                <div className="mb-5">
                  <div className="text-[10px] text-[var(--muted-4)] uppercase tracking-widest font-semibold mb-1">Objectif</div>
                  <p className="font-body-readable text-[14px] text-[var(--muted-1)] leading-relaxed">{project.objective}</p>
                </div>
              ) : null}

              {project.description ? (
                <div className="mb-5">
                  <div className="text-[10px] text-[var(--muted-4)] uppercase tracking-widest font-semibold mb-1">Description</div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-[11px] text-[var(--muted-5)] font-body-readable pt-5 border-t border-[var(--border-2)]">
            ...
            <div className="rounded-2xl border border-[var(--border-3)] bg-[var(--surface-1)] p-5 md:p-6">
              <div className="text-[10px] text-[var(--muted-4)] uppercase tracking-widest font-semibold mb-3">Réalise par</div>
              <Link href={localePath(`/profile/${project.authorId}`, locale)} className="flex items-center gap-4 group">
                <div className="w-12 h-12 rounded-xl border-2 border-[var(--border-4)] overflow-hidden shrink-0">
                  <img src={project.avatarUrl} alt={project.author} className="w-full h-full object-cover" />
                </div>
                <div className="min-w-0">
                  <div className="font-venite-italic text-[15px] text-[var(--text-primary)] group-hover:text-[#4F8EF7] transition-colors">{project.author}</div>
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    {project.track ? <span className="text-[11px] text-[var(--muted-4)]">{project.track}</span> : null}
                  </div>
                </div>
