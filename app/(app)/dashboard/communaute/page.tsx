...
export const metadata = buildPageMetadata({
  title: "Communaute",
  description: "Le fil de la communaute TakaCode: projets publies, likes et membres actifs.",
...
export default async function CommunityFeedPage() {
  ...
  return (
    <>
      <PageHeader title="COMMUNAUTE" subtitle={`${projects.length} projets · ${stats.totalLikes ?? "—"} likes`} />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        <div className="rounded-2xl border border-white/[0.08] bg-[#111] px-4 py-4 text-center">
          ...
          <div className="text-[10px] text-[#666] font-body-readable">Membres</div>
        </div>
        <div className="rounded-2xl border border-white/[0.08] bg-[#111] px-4 py-4 text-center">
          ...
          <div className="text-[10px] text-[#666] font-body-readable">Projets</div>
        </div>
        <div className="rounded-2xl border border-white/[0.08] bg-[#111] px-4 py-4 text-center">
          ...
          <div className="text-[10px] text-[#666] font-body-readable">Likes</div>
        </div>
        <div className="rounded-2xl border border-white/[0.08] bg-[#111] px-4 py-4 text-center">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[11px] text-[#888] font-body-readable">
                  {project.author} · {project.track || "Aucun parcours"}
