  ...
  return (
    <>
      ...
      <DocContent>
        ...
        <h3>Deroulement</h3>
        <ol>
          <li>Après une lecon, tu accedes au quiz associe.</li>
          ...
          <li>Le resultat s'affiche immediatement : score, reponses correctes/incorrectes et explications.</li>
        </ol>

        <h3>Conditions de reussite</h3>
        <ul>
          <li>Il faut au moins <strong>70% de bonnes reponses</strong> pour valider le quiz.</li>
          <li>Si tu echoues, tu peux retenter immediatement.</li>
        ...
        <p>
          ...
          Elles sont liees a des objectifs pedagogiques precis, ce qui t'aide a identifier les points a retravailler.
        </p>

        <h3>Conseils</h3>
        <ul>
          <li>Lis attentivement l'explication après chaque question, meme si tu as juste.</li>
          <li>Si une question te pose probleme, consulte la ressource associee dans la lecon.</li>
