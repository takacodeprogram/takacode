  ...
  return (
    <>
      ...
      <DocContent>
        ...
        <p>
          Les quiz valident ta comprehension des leçons. Chaque quiz est compose de plusieurs questions
          a choix multiples. Les choix sont melanges pour chaque utilisateur, ce qui rend chaque tentative unique.
        </p>

        <h3>Déroulement</h3>
        <ol>
          <li>Après une leçon, tu accedes au quiz associé.</li>
          <li>Pour chaque question, sélectionne une réponse parmi les choix proposees.</li>
        ...
        <ul>
          <li>Il faut au moins <strong>70% de bonnes réponses</strong> pour valider le quiz.</li>
        ...
        <p>
          Les questions sont classees par difficulte : <strong>fondation</strong>, <strong>standard</strong> et <strong>défi</strong>.
        ...
        <ul>
          ...
          <li>Si une question te pose problème, consulte la ressource associee dans la leçon.</li>
