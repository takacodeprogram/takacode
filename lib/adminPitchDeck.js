...
function addMockupFrame(slide, { x, y, w, h, title, subtitle, accent }) {
  slide.addShape("roundRect", {
    x,
    y,
    w,
  ...
  slide.addShape("line", {
    ...
    w: w - 0.32,
    h: 0,
    line: { color: accent || COLORS.blue, pt: 1.3 }
  });
  ...
  slide.addShape("roundRect", {
    ...
    h: h - 1.15,
    rectRadius: 0.05,
    fill: { color: "0D0D0D", transparency: 0 },
    line: { color: COLORS.border, pt: 1 }
  });
  ...
  slide.addShape("rect", {
    ...
    w: w - 0.4,
    h: 0.24,
    fill: { color: "191919", transparency: 0 },
    line: { color: "191919", transparency: 100 }
  });
  ...
  slide.addShape("ellipse", {
    ...
    w: 0.06,
    h: 0.06,
    fill: { color: "FF5F56", transparency: 0 },
    line: { color: "FF5F56", transparency: 100 }
  });
  ...
  slide.addShape("ellipse", {
    ...
    w: 0.06,
    h: 0.06,
    fill: { color: "FFBD2E", transparency: 0 },
    line: { color: "FFBD2E", transparency: 100 }
  });
  ...
  slide.addShape("ellipse", {
    ...
    w: 0.06,
    h: 0.06,
    fill: { color: "27C93F", transparency: 0 },
    line: { color: "27C93F", transparency: 100 }
  });
  ...
  slide.addShape("roundRect", {
    ...
    h: 0.28,
    rectRadius: 0.03,
    fill: { color: "1B1B1B", transparency: 0 },
    line: { color: "1B1B1B", transparency: 100 }
  });
  ...
  slide.addShape("roundRect", {
    ...
    h: 0.18,
    rectRadius: 0.03,
    fill: { color: "2B2B2B", transparency: 0 },
    line: { color: "2B2B2B", transparency: 100 }
  });
  ...
  slide.addShape("roundRect", {
    ...
    h: 0.18,
    rectRadius: 0.03,
    fill: { color: "252525", transparency: 0 },
    line: { color: "252525", transparency: 100 }
  });
...
function addMockupsSlide(pptx, appUrl) {
  const slide = pptx.addSlide();

  addHeader(slide, {
    label: "Mockups",
    title: "Espaces captures du site et maquette produit",
    appUrl
  });

  addMockupFrame(slide, {
    x: 0.62,
    y: 2.78,
    w: 7.46,
    h: 3.78,
    title: "Landing / Communaute",
    subtitle: "Zone principale pour capture hero + sections de conversion.",
    accent: COLORS.blue
  });
  ...
  addMockupFrame(slide, {
    ...
    subtitle: "Capture des etapes login / inscription.",
    accent: COLORS.cyan
  });
  ...
  addMockupFrame(slide, {
    ...
    subtitle: "Capture du control center et des onglets.",
    accent: COLORS.violet
  });

  slide.addText("Grille optimisee pour inserer des screenshots 16:9 sans chevauchement.", {
    x: 0.62,
    y: 6.76,
    w: 12.1,
    h: 0.24,
...
export async function buildAdminPitchDeckBuffer({ appUrl } = {}) {
  ...
  addMockupsSlide(pptx, resolvedAppUrl);
