...
export function mapTrackToRecommendation(track, fallbackTitle = "Parcours personnalisé") {
  if (!track) {
    return {
      ...
      nextSteps: [
        { label: "Démarrer le parcours", state: "current" },
        { label: "Valider la première étape", state: "locked" }
      ]
    };
  }
