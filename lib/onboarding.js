...
export const GOAL_OPTIONS = [
  ...
  { key: "three_d", label: "3D et expériences immersives", icon: "lucide:box", accent: "#8B5CF6" },
...
const RECOMMENDATION_PRESETS = {
  ...
  three_d: {
    parcoursTitle: "Parcours 3D et Expériences Immersives",
    parcoursMeta: "12 semaines - Création",
    resources: ["Blender foundations", "Modélisation 3D", "Projet : scene interactive"],
    objective: "Créer des expériences 3D pour le web, le jeu ou la visualisation.",
    nextSession: "Samedi 19h00",
    nextSteps: [
      { label: "Prendre en main Blender", state: "done" },
      { label: "Modéliser un premier asset", state: "current" },
  ...
  data_analysis: {
    parcoursTitle: "Parcours Analyse et Visualisation de Données",
  ...
  videos_youtube: {
    parcoursTitle: "Parcours Contenu et Vidéos",
  ...
  podcast_audio: {
    ...
    parcoursMeta: "8 semaines - Création",
    resources: ["Home studio minimal", "Mixage et mastering", "Projet : morceau ou épisode pilote"],
    objective: "Produire un projet musical ou audio de qualité et le publier.",
    nextSession: "Jeudi 19h00",
    nextSteps: [
      { label: "Choisir ton format", state: "done" },
      { label: "Composer ou enregistrer une première version", state: "current" },
  ...
  custom_projects: {
    parcoursTitle: "Parcours Projet Personnalisé",
  ...
  learn_explore: {
    parcoursTitle: "Parcours Découverte",
