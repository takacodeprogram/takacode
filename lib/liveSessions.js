...
function isMissingSchemaError(error) {
  ...
  return code === "PGRST205" || code === "42P01" || message.includes("live_sessions") || message.includes("schema cache");
}
...
// Vue membre: sessions publiees, separees en a venir et replays.
