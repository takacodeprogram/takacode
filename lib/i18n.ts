...
const FR: Translations = {
  ...
  lessonExperience: {
    ...
    stepsQuiz: "Quiz",
    stepsMicroProject: "Micro-projet",
    stepsValidated: "Validée",
    bravoProgress: "Bravo, tu progresses. Continue sur ta lancée !",
    congratulationsTrack: "Félicitations, tu as terminé toutes les leçons de ce parcours !",
    nextLesson: "Leçon suivante",
    shareLesson: "Je viens de valider la leçon \"{title}\" sur TakaCode ! 🚀",
    shareTrack: "J'ai terminé un parcours complet sur TakaCode ! 🏆",
    quizPassedTitle: "QUIZ VALIDE !",
    quizPassedWithProject: "Excellent. Termine le micro-projet pour valider la leçon.",
    quizPassedNoProject: "Excellent travail !",
    quizFail1: "Score {score}/{total} — il te faut 70%. Relis les ressources et réessaie, tu y es presque !",
    quizFail2: "Score {score}/{total} — Concentre-toi sur les notions clés dans les ressources ci-dessous.",
    quizFail3: "Score {score}/{total} — Les réponses justes sont surlignées en vert. Inspire-t-en pour le prochain essai.",
    dontGiveUp: "NE LACHE PAS !",
    almost: "PRESQUE !",
    rereadResources: "N'hésite pas à rouvrir les ressources.",
    retry: "Réessayer",
    changesRequested: "Des améliorations ont été demandées. ",
    aiNotAvailable: "L'IA n'est pas disponible. Ton projet est en attente de validation manuelle par un pair ou un mentor. Tu peux continuer en attendant.",
    retractResubmit: "Retraite ton projet en fonction des remarques et re-soumets.",
    improvementsRequestedTitle: "AMELIORATIONS DEMANDEES",
    pendingReviewTitle: "En attente de revue",
    aiReviewFailed: "La review IA n'a pas abouti (service surchargé ou momentanément indisponible). Ton projet part en revue manuelle par un pair ou un mentor. ",
    waitXpContinue: "Pas besoin d'attendre : continue la suite, l'XP arrive une fois validé.",
    waitXpReceive: "Tu recevras l'XP une fois le retour validé.",
    submittedPeerReview: "Un autre membre va relire ton travail et te donner un retour. ",
    submittedReview: "Ton travail part en revue. ",
    submittedForReviewTitle: "Soumis pour revue !",
    continue: "Continuer",
    ...
    pendingReviewStatus: "Micro-projet envoyé en revue. Tu peux continuer : l'XP et la validation arrivent après l'approbation.",
    ...
    quizPassed: "Quiz valide",
    quizAlreadyPassed: "Tu as déjà validé ce quiz",
    score: "Score : {score}/{total}",
    quizValidLabel: "- quiz valide",
    seventyRequired: "- 70% requis",
    correcting: "Correction...",
    validateAnswers: "Valider mes réponses",
    microProjectSection: "MICRO PROJET",
    peerReview: "Revue par les pairs",
    mentorReview: "Revue mentor",
    aiReviewMode: "Validation IA",
    improvementsRequestedBadge: "Améliorations demandées",
    approved: "Valide",
    submitted: "Soumis",
    deliverableForProject: "Livrable pour TON projet \"{title}\" : ",
    deliverableExpected: "Livrable attendu : ",
    waitingAIReview: "En attente de revue IA ou manuelle.",
    waitingPeerReview: "En attente d'une revue par les pairs.",
    waitingMentorReview: "En attente d'une revue mentor.",
    codePlaceholder: "Colle ici ton code, ta description, ou tout livrable texte...",
    linkLabel: "Lien (optionnel)",
    linkPlaceholder: "https://github.com/ton-repo, https://ton-site.com...",
    uploading: "Upload...",
    attachFile: "Joindre un fichier",
    viewFile: "Voir le fichier",
    shortDeliverable: "Ton livrable est assez court. Assure-toi d'avoir bien inclus tout ce qui est demandé (lien, explications, etc.).",
    sending: "Envoi...",
    resubmit: "Re-soumettre",
    updateSubmission: "Mettre à jour ma soumission",
    submitForReview: "Soumettre pour revue",
    submitMicroProject: "Soumettre mon micro projet",
    previousLesson: "Leçon précédente",
    errorSessionExpired: "Ta session a expiré. Reconnecte-toi pour continuer.",
    errorLessonNotFound: "Cette leçon n'est plus disponible.",
    errorModuleLocked: "Ce module est encore verrouillé : termine d'abord les modules précédents.",
    errorInvalidAnswers: "Réponds à toutes les questions avant de valider.",
    errorSubmissionTooShort: "Décris ton travail un peu plus en détail (20 caractères minimum).",
    errorSubmissionTooLong: "Ta soumission est trop longue (5000 caractères maximum).",
    errorInvalidPayload: "Requête invalide. Recharge la page et réessaie.",
    errorNetwork: "Impossible de contacter le serveur. Vérifie ta connexion et réessaie.",
  ...
  home: {
    hero: {
      ...
      title2: "CONSTRUIRE",
      title3: "PROGRESSER",
      subtitle: "Trouve une direction, apprends en construisant et transforme tes projets en expériences que tu peux montrer et valoriser.",
      subtitleHighlight: "apprends en construisant",
  ...
  dashboardProjectPlan: {
    ...
    summaryTitle: "TON PLAN",
    open: "Ouvrir le projet",
    summaryEmpty: "Ce projet n'a pas encore de plan.",
    summaryEmptyCta: "Choisir un framework et generer le plan",
    allDone: "Toutes les etapes sont terminees.",
    start: "Commencer",
    complete: "Marquer terminee",
    block: "Je suis bloque",
    resume: "Reprendre",
    reopen: "Rouvrir",
    skip: "Ignorer",
    actionError: "Echec. Reessaie.",
  ...
  communityContent: {
    ...
    commentsHide: "Masquer les commentaires",
  ...
  accountSecurity: {
    title: "Securite",
    subtitle: "Connexion et appareils",
    lastSignIn: "Dernière connexion",
    notAvailable: "Non disponible",
    connectedDevices: "Appareils connectes ({n})",
    unknownDevice: "Appareil inconnu",
    current: "Actuel",
    dangerZone: "Zone dangereuse",
    dangerSubtitle: "Desactivation ou suppression",
    dangerDesc: "Desactiver cache ton profil et désactive les notifications. Supprimer efface toutes tes données de manière irreversible.",
    deactivateBtn: "Desactiver mon compte",
    deleteBtn: "Supprimer mon compte",
    confirmDeactivate: "Desactiver ton compte ? Tu pourras le reactiver en contactant l'équipe.",
    confirmDelete: "Supprimer definitivement ton compte ? Toutes tes données seront perdues.",
    confirmDelete2: "Confirmation : es-tu sur de vouloir supprimer ton compte ?",
    deactivated: "Compte désactive. A bientôt !",
    deleted: "Compte supprime. Redirection..."
  },
  deployGuide: {
    sectionLabel: "Publication guidee",
    title: "Deploie {name}",
    intro: "Suis ces étapes pour mettre ton projet en ligne. Chaque étape te rapproche d'un produit accessible au monde entier.",
    step1Title: "1. Cree ton depot GitHub",
    step1Desc: "Héberge ton code sur GitHub pour versionner et déployer automatiquement.",
    step1Action: "Créer le dépôt",
    step2Title: "2. Deploie sur Vercel",
    step2Desc: "Connecte ton dépôt GitHub a Vercel pour un déploiement automatique à chaque push.",
    step2Action: "Déployer sur Vercel",
    step3Title: "3. Ajoute ton domaine",
    step3Desc: "Configure un nom de domaine personnalise pour ton projet (ex: monprojet.com).",
    step3Action: "Ajouter un domaine",
    done: "Fait",
    viewDoc: "Voir la doc"
  },
  adminMicroProject: {
    title: "MICRO-PROJET",
    labelTitle: "Titre *",
    placeholderTitle: "Titre du micro-projet",
    ...
    placeholderBrief: "Explique le travail attendu...",
    steps: "Étapes",
    stepPlaceholder: "Etape {n}",
    deleteStep: "Supprimer l'etape",
    addStep: "Ajouter une étape",
    deliverable: "Livrable attendu",
    placeholderDeliverable: "Ce qui doit être rendu (lien, fichier, description...)",
    requiresLink: "L'apprenant doit fournir un lien (URL)"
  },
  adminTrackPreview: {
    preview: "Apercu",
    notDefined: "Non défini",
    summaryPlaceholder: "Résumé du parcours...",
    viewDetails: "Voir les détails",
    trackTitle: "Titre du parcours"
  },
  adminResources: {
    title: "RESSOURCES",
    resourceLabel: "Ressource #{n}",
    deleteResource: "Supprimer la ressource",
    placeholderTitle: "Titre de la ressource",
    placeholderUrl: "https://...",
    placeholderWhy: "Pourquoi cette ressource est utile",
    placeholderHow: "Comment l'utiliser",
  ...
  adminUsers: {
    ...
    sectionTitle: "UTILISATEURS ET ROLES",
    ...
    adminWarning: "Attention : le rôle Admin donne un accès complet à la plateforme (utilisateurs, parcours, sessions, paramètres).",
    roleUser: "Membre",
    roleUserDesc: "Apprend, suit les parcours, publie ses projets.",
    roleMentor: "Mentor",
    roleMentorDesc: "Membre + anime des sessions live et accompagne les autres.",
    roleAdmin: "Admin",
    roleAdminDesc: "Accès complet : utilisateurs, parcours, leçons, sessions, paramètres.",
    errNotAuthenticated: "Session expirée, reconnecte-toi.",
    errForbidden: "Action réservée aux admins.",
    errInvalidRole: "Rôle invalide.",
    errCannotChangeSelf: "Tu ne peux pas modifier ton propre rôle.",
    errUserNotFound: "Utilisateur introuvable.",
    errLastAdmin: "Impossible : il doit rester au moins un admin.",
    errRpcMissing: "Fonction de rôle absente. Lance supabase/sql/011_role_management.sql.",
    roleChanged: "Rôle de {user} : {role}."
  },
  adminFrameworks: {
    metaTitle: "Frameworks",
    metaDesc: "Les gabarits de projet : phases, etapes et criteres.",
    title: "FRAMEWORKS",
    subtitle: "Les gabarits qui deviennent le plan d'un Builder",
    intro: "Un framework decrit les grandes phases d'une categorie de projet, et sous chaque phase ce que le Builder doit produire. On n'y redige pas de lecon : on y decrit un livrable attendu et les criteres qui disent que l'etape est terminee.",
    empty: "Aucun framework pour l'instant.",
    emptyHint: "Applique les migrations project-first, puis seede un premier framework.",
    published: "Publie",
    draft: "Brouillon",
    phases: "phases",
    steps: "etapes",
    noStepWarning: "Ce framework n'a aucune etape : il ne peut generer aucun plan."
  },
  adminTracks: {
  ...
  adminSessions: {
    ...
    fieldTrack: "Parcours lié",
    fieldJoinUrl: "Lien pour rejoindre",
    fieldReplayUrl: "Lien du replay",
    noTrack: "Aucun",
    ...
    replayUrlPlaceholder: "https://youtube..."
  },
  adminSessionNew: {
  ...
  adminAi: {
    ...
    testResponseMs: "Reponse en {n}ms",
    testResponseModel: "Reponse du modele",
    testWorking: "La review automatique des micro-projets est operationnelle.",
    testFailed: "Échec de la connexion",
    testErrorUnknown: "Erreur inconnue",
    testCheckApi: "Vérifie ta clé API et que le provider est bien accessible depuis ton réseau.",
    testConnecting: "Connexion au provider IA en cours...",
    testErrorInvalid: "Réponse serveur invalide",
    testErrorNetwork: "Erreur réseau",
    testErrorContact: "Impossible de contacter le serveur"
  },
  adminAffiliates: {
  ...
  adminQuestions: {
    ...
    title: "BANQUE DE QUESTIONS",
    desc: "Chaque question doit vérifier un objectif et s'appuyer sur une ressource de la leçon.",
    add: "Ajouter une question",
    questionLabel: "QUESTION {n}",
    source: "Source {source}",
    promptAria: "Énoncé de la question {n}",
    correctAnswer: "Bonne réponse",
    choiceLabel: "Choix {n}",
    explanationPlaceholder: "Explication pédagogique après correction",
    explanationAria: "Explication pédagogique",
    fieldObjective: "Objectif vérifié",
    noObjective: "Non rattaché",
    fieldResource: "Ressource de référence",
    noResource: "Non rattachée",
    fieldDifficulty: "Difficulté",
    difficultyFoundation: "Fondation",
    difficultyStandard: "Standard",
    difficultyChallenge: "Challenge",
    fieldStatus: "Publication",
    ...
    empty: "Aucune question dans cette banque.",
    confirmDelete: "Supprimer cette question de la banque ?"
  },
  trackForm: {
    ...
    startSteps: "Démarrer le parcours",
    versionAuto: "Sauvegarde automatique",
    versionManual: "Sauvegarde manuelle",
    trackFallback: "Parcours en préparation.",
    currentLabel: "Actuel: ",
...
const EN: Translations = {
  ...
  lessonExperience: {
    ...
    stepsQuiz: "Quiz",
    stepsMicroProject: "Micro-project",
    stepsValidated: "Validated",
    bravoProgress: "Great job, keep going!",
    congratulationsTrack: "Congratulations, you completed all the lessons in this track!",
    nextLesson: "Next lesson",
    shareLesson: "I just validated the lesson \"{title}\" on TakaCode! 🚀",
    shareTrack: "I completed an entire track on TakaCode! 🏆",
    quizPassedTitle: "QUIZ PASSED!",
    quizPassedWithProject: "Excellent. Complete the micro-project to validate the lesson.",
    quizPassedNoProject: "Excellent work!",
    quizFail1: "Score {score}/{total} — you need 70%. Re-read the resources and try again, you're almost there!",
    quizFail2: "Score {score}/{total} — Focus on the key concepts in the resources below.",
    quizFail3: "Score {score}/{total} — Correct answers are highlighted in green. Use them for your next attempt.",
    dontGiveUp: "DON'T GIVE UP!",
    almost: "ALMOST!",
    rereadResources: "Feel free to reopen the resources.",
    retry: "Retry",
    changesRequested: "Improvements have been requested. ",
    aiNotAvailable: "AI is not available. Your project is pending manual review by a peer or mentor. You can continue in the meantime.",
    retractResubmit: "Rework your project based on the feedback and resubmit.",
    improvementsRequestedTitle: "IMPROVEMENTS REQUESTED",
    pendingReviewTitle: "Pending review",
    aiReviewFailed: "AI review failed (service overloaded or temporarily unavailable). Your project goes to manual review by a peer or mentor. ",
    waitXpContinue: "No need to wait: keep going, XP arrives once validated.",
    waitXpReceive: "You'll receive XP once the review is approved.",
    submittedPeerReview: "Another member will review your work and give you feedback. ",
    submittedReview: "Your work is being reviewed. ",
    submittedForReviewTitle: "Submitted for review!",
    continue: "Continue",
    projectSubmittedTitle: "Project submitted!",
    validateQuizToFinish: "Complete the quiz to finish the lesson.",
    goodWorkSaved: "Good work, it's saved.",
    lessonValidatedLabel: "Lesson validated",
    xpEarned: "+{xp} XP earned",
    trackCompleteBack: "Track completed, back to program",
    changesRequestedStatus: "Improvements have been requested on this micro-project. You can continue while you rework it.",
    pendingReviewStatus: "Micro-project sent for review. You can continue: XP and validation come after approval.",
    ...
    quizAlreadyPassed: "You already passed this quiz",
    score: "Score: {score}/{total}",
    quizValidLabel: "- quiz passed",
    seventyRequired: "- 70% required",
    correcting: "Correcting...",
    validateAnswers: "Validate my answers",
    microProjectSection: "MICRO PROJECT",
    peerReview: "Peer review",
    mentorReview: "Mentor review",
    aiReviewMode: "AI validation",
    improvementsRequestedBadge: "Improvements requested",
    approved: "Approved",
    submitted: "Submitted",
    deliverableForProject: "Deliverable for YOUR project \"{title}\": ",
    deliverableExpected: "Expected deliverable: ",
    waitingAIReview: "Waiting for AI or manual review.",
    waitingPeerReview: "Waiting for peer review.",
    waitingMentorReview: "Waiting for mentor review.",
    codePlaceholder: "Paste your code, description, or any text deliverable here...",
    linkLabel: "Link (optional)",
    linkPlaceholder: "https://github.com/your-repo, https://your-site.com...",
    uploading: "Uploading...",
    attachFile: "Attach a file",
    viewFile: "View file",
    shortDeliverable: "Your deliverable is quite short. Make sure you've included everything required (link, explanations, etc.).",
    sending: "Sending...",
    resubmit: "Resubmit",
    updateSubmission: "Update my submission",
    submitForReview: "Submit for review",
    submitMicroProject: "Submit my micro project",
    previousLesson: "Previous lesson",
    errorSessionExpired: "Your session expired. Sign in again to continue.",
    errorLessonNotFound: "This lesson is no longer available.",
    errorModuleLocked: "This module is still locked: complete previous modules first.",
    errorInvalidAnswers: "Answer all questions before validating.",
    errorSubmissionTooShort: "Describe your work in a bit more detail (20 characters minimum).",
    errorSubmissionTooLong: "Your submission is too long (5000 characters maximum).",
    errorInvalidPayload: "Invalid request. Reload the page and try again.",
    errorNetwork: "Unable to reach the server. Check your connection and try again.",
    errorGeneric: "An error occurred. Try again shortly."
  },
  home: {
    hero: {
      ...
      title2: "BUILD",
      title3: "GROW",
      subtitle: "Find a direction, learn by building, and turn your projects into experience you can show and put to work.",
      subtitleHighlight: "learn by building",
      ...
      statTracks: "Tracks",
      roadmapLabel: "YOUR PATH",
      roadmapStatus: "From direction to proof",
      roadmapIdea: "DIRECTION",
      roadmapDone: "Found",
      roadmapTrack: "BUILDING",
      roadmapInProgress: "In progress",
      roadmapMonetization: "PROOF",
      ...
      floatingSessionInfo: "Group unblocking"
    },
    stats: {
      members: "Members",
  ...
  dashboardProjectPlan: {
    ...
    summaryEmpty: "This project has no plan yet.",
    summaryEmptyCta: "Pick a framework and generate the plan",
  ...
  accountSecurity: {
    title: "Security",
    subtitle: "Connections and devices",
    ...
    dangerSubtitle: "Deactivation or deletion",
    dangerDesc: "Deactivate hides your profile and disables notifications. Delete permanently erases all your data.",
    deactivateBtn: "Deactivate my account",
    deleteBtn: "Delete my account",
    confirmDeactivate: "Deactivate your account? You can reactivate it by contacting the team.",
    confirmDelete: "Permanently delete your account? All your data will be lost.",
    confirmDelete2: "Confirmation: are you sure you want to delete your account?",
    deactivated: "Account deactivated. See you soon!",
    deleted: "Account deleted. Redirecting..."
  },
  deployGuide: {
    sectionLabel: "Guided publication",
    title: "Deploy {name}",
    intro: "Follow these steps to put your project online. Each step gets you closer to a product accessible worldwide.",
    step1Title: "1. Create your GitHub repo",
    step1Desc: "Host your code on GitHub for version control and automatic deployment.",
    step1Action: "Create the repo",
    step2Title: "2. Deploy on Vercel",
    step2Desc: "Connect your GitHub repo to Vercel for automatic deployment on every push.",
    step2Action: "Deploy on Vercel",
    step3Title: "3. Add your domain",
    step3Desc: "Configure a custom domain name for your project (e.g. myproject.com).",
    step3Action: "Add a domain",
    done: "Done",
    viewDoc: "View docs"
  },
  adminMicroProject: {
    title: "MICRO-PROJECT",
    labelTitle: "Title *",
    placeholderTitle: "Micro-project title",
    ...
    placeholderBrief: "Explain the expected work...",
    steps: "Steps",
    stepPlaceholder: "Step {n}",
    deleteStep: "Delete step",
    addStep: "Add a step",
    deliverable: "Expected deliverable",
    placeholderDeliverable: "What needs to be submitted (link, file, description...)",
    requiresLink: "The learner must provide a link (URL)"
  },
  adminTrackPreview: {
    preview: "Preview",
    notDefined: "Not defined",
    summaryPlaceholder: "Track summary...",
    viewDetails: "View details",
    trackTitle: "Track title"
  },
  adminResources: {
    title: "RESOURCES",
    resourceLabel: "Resource #{n}",
    deleteResource: "Delete resource",
    placeholderTitle: "Resource title",
    placeholderUrl: "https://...",
    placeholderWhy: "Why this resource is useful",
    placeholderHow: "How to use it",
  ...
  adminUsers: {
    ...
    sectionDesc: "Change points directly. Role changes require confirmation and are logged.",
    userCount: "{n} user(s)",
    apply: "Apply",
    ...
    confirm: "Confirm",
    applying: "Applying...",
    adminWarning: "Warning: the Admin role grants full platform access (users, tracks, sessions, settings).",
    roleUser: "Member",
    roleUserDesc: "Learns, follows tracks, publishes projects.",
    roleMentor: "Mentor",
    roleMentorDesc: "Member + hosts live sessions and mentors others.",
    roleAdmin: "Admin",
    roleAdminDesc: "Full access: users, tracks, lessons, sessions, settings.",
    errNotAuthenticated: "Session expired, please reconnect.",
    errForbidden: "Action reserved for admins.",
    errInvalidRole: "Invalid role.",
    errCannotChangeSelf: "You cannot change your own role.",
    errUserNotFound: "User not found.",
    errLastAdmin: "Cannot: at least one admin must remain.",
    errRpcMissing: "Missing role function. Run supabase/sql/011_role_management.sql.",
    roleChanged: "Role of {user}: {role}."
  },
  adminFrameworks: {
    metaTitle: "Frameworks",
    metaDesc: "Project templates: phases, steps and criteria.",
    title: "FRAMEWORKS",
    subtitle: "The templates that become a Builder's plan",
    intro: "A framework describes the phases of a project category, and under each phase what the Builder has to produce. You do not write a lesson here: you describe an expected deliverable and the criteria that say the step is done.",
    empty: "No framework yet.",
    emptyHint: "Apply the project-first migrations, then seed a first framework.",
    published: "Published",
    draft: "Draft",
    phases: "phases",
    steps: "steps",
    noStepWarning: "This framework has no step: it cannot generate any plan."
  },
  adminTracks: {
  ...
  adminSessions: {
    ...
    fieldTrack: "Linked track",
    fieldJoinUrl: "Join link",
    fieldReplayUrl: "Replay link",
    noTrack: "None",
    ...
    delete: "Delete",
    deleting: "Deleting...",
    publishedLabel: "Published (visible to members)",
    confirmDelete: "Delete this session? This action is irreversible.",
    titlePlaceholder: "E.g.: Live workshop - deploy on Vercel",
    joinUrlPlaceholder: "https://meet...",
    replayUrlPlaceholder: "https://youtube..."
  },
  adminSessionNew: {
  ...
  adminAi: {
    ...
    testResponseMs: "Response in {n}ms",
    testResponseModel: "Model response",
    testWorking: "Automatic micro-project review is operational.",
    testFailed: "Connection failed",
    testErrorUnknown: "Unknown error",
    testCheckApi: "Check your API key and ensure the provider is accessible from your network.",
    testConnecting: "Connecting to AI provider...",
    testErrorInvalid: "Invalid server response",
    testErrorNetwork: "Network error",
    testErrorContact: "Unable to reach the server"
  },
  adminAffiliates: {
  ...
  adminQuestions: {
    ...
    title: "QUESTION BANK",
    desc: "Each question must verify an objective and reference a lesson resource.",
    add: "Add a question",
    questionLabel: "QUESTION {n}",
    source: "Source {source}",
    promptAria: "Question prompt {n}",
    correctAnswer: "Correct answer",
    choiceLabel: "Choice {n}",
    explanationPlaceholder: "Pedagogical explanation after answering",
    explanationAria: "Pedagogical explanation",
    fieldObjective: "Verified objective",
    noObjective: "Not linked",
    fieldResource: "Reference resource",
    noResource: "Not linked",
    ...
    empty: "No questions in this bank.",
    confirmDelete: "Delete this question from the bank?"
  },
  trackForm: {
    ...
    trackDefault: "Track",
    startSteps: "Start the track",
    versionAuto: "Auto-save",
    versionManual: "Manual save",
    trackFallback: "Track in preparation.",
