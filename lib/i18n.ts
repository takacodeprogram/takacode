...
const FR: Translations = {
  ...
  home: {
    hero: {
      ...
      title2: "CONSTRUIRE",
      title3: "PROGRESSER",
      subtitle: "Trouve une direction, construis un projet concret et apprends ce dont tu as besoin au moment où tu en as besoin. Chaque réalisation devient une preuve d'expérience capable d'ouvrir de nouvelles opportunités.",
      subtitleHighlight: "preuve d'expérience",
...
const EN: Translations = {
  ...
  home: {
    hero: {
      ...
      title2: "BUILD",
      title3: "GROW",
      subtitle: "Find a direction, build something real, and learn what you need exactly when you need it. Every finished project becomes proof of experience that can open new opportunities.",
      subtitleHighlight: "proof of experience",
