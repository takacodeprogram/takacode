    ...
    <section className="relative pt-[64px] min-h-screen flex items-center overflow-hidden" id="hero">
      ...
      <div className="relative z-10 max-w-[1320px] mx-auto px-8 w-full py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          {/* Left column: core value proposition, CTAs, and social proof */}
          <div>
          ...
          {/* Right column: roadmap preview with animated progress bars */}
          <div className="float-anim relative pt-20 pb-20 sm:pt-12 sm:pb-12">
            <div className="bg-[#111] border border-white/[0.07] rounded-2xl px-6 py-8 glow-blue relative overflow-hidden z-10">
              ...
              <div className="relative z-10">
                ...
                {/*
                  Each bar defines its own animation timing and palette through CSS variables:
                  --target-width, --progress-delay, --progress-start, --progress-end, --progress-accent, --progress-glow
                */}
                <div className="space-y-4 roadmap-progress-list">
                  <div className="roadmap-progress-item roadmap-progress-item-1">
                    ...
                    <div className="h-1 bg-white/[0.05] rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ "--target-width": "100%", "--progress-delay": "0.1s", "--progress-start": "#22c55e", "--progress-end": "#86efac", "--progress-accent": "#dcfce7", "--progress-glow": "rgba(34,197,94,0.45)" }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="roadmap-progress-item roadmap-progress-item-2">
                    ...
                    <div className="h-1 bg-white/[0.05] rounded-full overflow-hidden">
                      <div
                        className="progress-bar h-full roadmap-progress-fill"
                        style={{ "--target-width": "62%", "--progress-delay": "0.28s", "--progress-start": "#4F8EF7", "--progress-end": "#22D3EE", "--progress-accent": "#bfdbfe", "--progress-glow": "rgba(79,142,247,0.42)" }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="roadmap-progress-item roadmap-progress-item-3">
                    ...
                    <div className="h-1 bg-white/[0.05] rounded-full overflow-hidden">
                      <div
                        className="progress-bar h-full roadmap-progress-fill"
                        style={{ "--target-width": "15%", "--progress-delay": "0.46s", "--progress-start": "#f59e0b", "--progress-end": "#f97316", "--progress-accent": "#fdba74", "--progress-glow": "rgba(245,158,11,0.4)" }}
                      />
                    </div>
                  </div>
                </div>
            ...
            {/* Floating status badges around the roadmap card */}
            <div
