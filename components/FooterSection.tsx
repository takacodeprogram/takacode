    ...
    <footer className="py-16">
      <div className="max-w-[1320px] mx-auto px-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-12">
          ...
          <p className="font-body-readable text-[12px] text-[#444]">Crée, publie et monétise ton projet digital.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
          ...
          <div>
            ...
            <div className="space-y-2.5 font-body-readable">
              <div><Link href="/privacy" id="footer-privacy-link" className="text-[12px] text-[#555] hover:text-white transition-colors">Confidentialité</Link></div>
