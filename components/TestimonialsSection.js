      ...
      <div className="max-w-[1320px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="bg-[#111] border border-white/[0.07] rounded-2xl p-7 testimonial-card card-hover">
            ...
            <p className="font-body-readable text-[13px] text-[#888] leading-relaxed mb-6 italic">
              "J'ai lance mon premier configurateur 3D et une version Web3 de mon projet grace au parcours. Les ateliers live m'ont aide a passer de l'idee au produit."
            </p>
            <div className="flex items-center gap-3 pt-5 border-t border-white/[0.05]">
              ...
              <div>
                ...
                <div className="font-body-readable text-[11px] text-[#555]">Parcours Web3 & 3D</div>
              </div>
            </div>
          </div>
        </div>
