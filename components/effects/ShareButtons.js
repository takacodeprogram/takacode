...
// Boutons de partage social (X, LinkedIn, Facebook) + copie du lien.
// Partage un texte + une URL (victoire, progression, rang...).
export default function ShareButtons({ text = "", url = "", compact = false }) {
  ...
  return (
    <div className="flex items-center justify-center gap-2 flex-wrap">
      ...
      >
        ...
        {copied ? "Copie !" : compact ? null : "Copier"}
      </button>
    </div>
  );
}
