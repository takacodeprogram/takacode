  ...
  return (
    <main className="min-h-screen bg-[var(--bg-app)] text-[var(--text-primary)] px-6 py-20 md:py-24 flex items-center justify-center">
      <div className="w-full max-w-[560px] bg-[var(--surface-1)] border border-[var(--border-3)] rounded-3xl p-8 sm:p-10">
        ...
        {emailSent ? (
          <>
            <p className="font-body-readable text-[14px] text-[var(--muted-3)] leading-relaxed mb-3">
              {t("auth.forgotPasswordSentDesc")} <span className="text-[var(--text-primary)]">{email}</span>.
            </p>
          ...
          <>
            <p className="font-body-readable text-[14px] text-[var(--muted-3)] leading-relaxed mb-6">
              {t("auth.forgotPasswordDesc")}
            </p>
            <div className="mb-8 rounded-xl border border-[var(--border-3)] bg-[var(--overlay-2)] px-4 py-3">
              <div className="text-[12px] text-[var(--text-primary)] font-medium mb-1">{t("auth.forgotPasswordWaiting")}</div>
              <p className="text-[12px] text-[var(--muted-3)] font-body-readable">{t("auth.forgotPasswordWaitingSub")}</p>
            </div>
          </>
        )}
        ...
        <div className="mt-8 pt-6 border-t border-[var(--border-1)] flex items-center justify-between text-[13px]">
