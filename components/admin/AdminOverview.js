...
// Vue globale admin (lecture seule): compteurs reels + leaderboard.
export default function AdminOverview({ users = [], tracks = [], platformStats = null, systemIssues = [] }) {
